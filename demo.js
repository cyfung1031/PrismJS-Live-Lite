    ...
    for(const t of document.querySelectorAll("textarea.language-html.fill"))
        t.value = `
    ...
    <body>
    <!-- Example Coding -->
      <h1 class="heading">Heading for the content below</h1>
      <div class="content">
        <p>Text text text</p>
        <img src="https://prismjs.com/assets/logo.svg" alt="Prism">
      </div>
    </body>
    ...
    for(const t of document.querySelectorAll("textarea.language-css.fill")){
        t.value = css;
    ...
    */
    ...
    for(const t of document.querySelectorAll("textarea.language-js.fill")){
        t.value = js;
        t.dispatchEvent(new InputEvent("input"));
    };
